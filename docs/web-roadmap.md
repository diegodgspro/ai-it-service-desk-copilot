# Proposed web development phase

Status: roadmap only, prepared 2026-09-07. No web migration or deployment is included in this phase. Keep all project content in English.
